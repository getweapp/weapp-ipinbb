Page({
  ...
  onLoad: function(e) {     // 首次加载
    var self = this;
    wx.request({            // 列表数据请求
      url: 'https://api.getweapp.com/thirdparty/ipinbb/home/load?ti=-1&ft=Home',
      header: {
    ...
    wx.request({            // 导航栏数据请求;
      url: 'https://api.getweapp.com/thirdparty/ipinbb/goodsService/getHomeTabs',
      header: {
          'Content-Type': 'application/json'
      },
      success: function(res) {
    ...
    wx.request({            // banner图数据请求;
      url: 'https://api.getweapp.com/thirdparty/ipinbb/goodsService/getHomeBanner',
      header: {
          'Content-Type': 'application/json'
      },
      success: function(res) {
  ...
  navLink: function(e) {    // nav导航栏切换
    ...
    wx.request({            // nav导航栏切换数据请求;
      url: 'https://api.getweapp.com/thirdparty/ipinbb/home/load',
      data : {
        nextPage : nextPage,
        ti : tabIndex,
        ft : category,
